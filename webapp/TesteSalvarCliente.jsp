    ...
    <div tabindex="0" class="content" onfocus="closeSidebar()" id="content">
        ...
        <div class="centro"> 
		 ...
		 <!--		   <h2>Endereço de Cobrança</h2>
		    ...
		    <label for="txtNumeroCobranca">Número:</label>
		    ...
		    <label for="chkMesmoEndereco">Mesmo endereço de cobrança e entrega</label>-->
		    ...
		    <label for="txtNumeroEntrega">Número:</label>
		    ...
		    <label for="txtDataValidadeCartao">Data de Validade do Cartão:</label>
...
<script>
	...
	// Função para preencher campos de entrega com os valores dos campos de cobrança
	   function preencherEnderecoEntrega() {
        if (document.getElementById('chkMesmoEndereco').checked) {
            // Obtenha os valores dos campos de cobrança
            ...
            // Preencha os campos de entrega com os valores de cobrança
            ...
            // Se a caixa não estiver marcada, apague os campos de entrega
    ...
    // Chame a função para configurar inicialmente os campos de entrega com base na caixa de seleção
